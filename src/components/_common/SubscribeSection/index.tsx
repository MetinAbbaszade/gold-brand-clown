...
const SubscribeSection: React.FC<IProp> = ({ playfair }) => {
	return (
		<MotionStack
			...
			alignItems={"center"}
		>
			<Stack maxWidth={"600px"} textAlign={"center"} spacing={4}>
				<Typography fontFamily={playfair.style.fontFamily} variant="h4">
					Join Our Inner Circle
				</Typography>
				<Typography>
					Be the first to receive exclusive updates, private event invitations,
					and collection previews. Your Email Address
				</Typography>
				<Stack direction={"row"}>
					<TextField
						id="outlined-basic"
